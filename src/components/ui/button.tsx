 ...
 "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
 {
  variants: {
   variant: {
    ...
    custom:
     "bg-transparent border-none hover:border border-red-600 hover:text-white text-sm py-2 px-6 bg-primary-red hover:bg-transparent  hover:backdrop-blur-xl text-white/95 rounded-none",
   },
   effect: {
   ...
   >
    <div className="flex items-center">
     ...
     {Icon &&
      iconPlacement === "right" &&
      (effect === "expandIcon" ? (
       <div className="w-0 -mb-0.5 translate-x-[100%] pl-0 opacity-0 transition-all duration-200 group-hover:w-5 group-hover:translate-x-0 group-hover:pl-2 group-hover:opacity-100">
        <Icon />
       </div>
      ) : (
       <Icon />
