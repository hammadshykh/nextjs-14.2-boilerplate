import { IndustryInnovatingCardsDataType } from "@/types";

// Define the constant with the data
const industryInnovatingCardsData: IndustryInnovatingCardsDataType[] = [
 {
  id: "1",
  title: "Analyze",
  description:
...
export default industryInnovatingCardsData;
